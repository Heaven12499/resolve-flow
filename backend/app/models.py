...
class KnowledgeEvaluationRun(Base):
    ...
    recall_at_1: Mapped[float] = mapped_column(default=0.0)
    recall_at_3: Mapped[float] = mapped_column()
    mrr: Mapped[float] = mapped_column(default=0.0)
    no_answer_cases: Mapped[int] = mapped_column(default=0)
    correct_rejection_cases: Mapped[int] = mapped_column(default=0)
